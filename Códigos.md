...
pygame.init()
arduino = serial.Serial('COM11', 9600, timeout=1) #A porta COM muda de número de aparelho para aparelho, então, para garantir o funcionamento, confira a do seu aparelho e altere no código
